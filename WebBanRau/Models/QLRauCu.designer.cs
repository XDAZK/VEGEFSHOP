...
namespace WebBanRau.Models
{
	...
	public partial class QLRauCuDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteNCC(NCC instance);
		...
		public QLRauCuDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QLRauCuDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QLRauCuDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QLRauCuDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnMaNCCChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Anhbia", DbType="NVarChar(1000)")]
    ...
    partial void OnLyDoChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaHotro", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int MaHotro
		{
			get
			{
